...
```
curl -Lo ~/sb.tar.gz https://github.com/SagerNet/sing-box/releases/download/v1.12.10/sing-box-1.12.10-linux-amd64.tar.gz && \
tar -xzf ~/sb.tar.gz -C ~/ && \
...
```
curl -Lo ~/sb.tar.gz https://github.com/SagerNet/sing-box/releases/download/v1.12.10/sing-box-1.12.10-linux-arm64.tar.gz && \
tar -xzf ~/sb.tar.gz -C ~/ && \
sudo cp -f ~/sing-box-*/sing-box /usr/local/bin/ && \
rm -rf ~/sb.tar.gz ~/sing-box-*
```
