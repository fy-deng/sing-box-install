...
```
GOOS=windows GOARCH=amd64 GOAMD64=v3 go install -v -tags with_quic,with_gvisor,with_utls,with_reality_server github.com/sagernet/sing-box/cmd/sing-box@dev-next
```
